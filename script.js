...
function checkTheElement(nmbr) {
	...
	if(scored == true){
		...
		//Wrong Answers
		wrongAnswerCount++;
		var gallowImage = "img/g"+wrongAnswerCount+".jpg";
		document.getElementById("gallow").innerHTML = '<img src="'+gallowImage+'" alt=""/>';
	}
	
	//win
	if (sentence == sentence1)
		document.getElementById("alphabet").innerHTML = "You are right! Full sentence is: "+sentence+'<br /><br /><span class="reset" onclick="location.reload()">ONE MORE TIME?</span>';
	
	//lost
	if (wrongAnswerCount>=9)
		document.getElementById("alphabet").innerHTML = "You are wrong! Correct sentence is: "+sentence+'<br /><br /><span class="reset" onclick="location.reload()">ONE MORE TIME?</span>';
}